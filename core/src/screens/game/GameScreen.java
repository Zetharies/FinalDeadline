...
public class GameScreen extends AbstractScreen {
    ...
    public void show() {
        ...
        TiledMap mapCollisonsTraps = new TmxMapLoader().load(maps.get(1).getMapLocation());
        ...
        traps = new BoobyTrap((TiledMapTileLayer) mapCollisonsTraps.getLayers().get(0));
...
//        camera.position.x = player.getLinearX() * 64;
        TiledMapTileLayer collisions = (TiledMapTileLayer) loadedMap.getLayers().get(0);

        for (int i = 0; i < zombies.size(); i++) {
            if (collisions.getCell((int) zombies.get(i).x, (int) zombies.get(i).y).getTile().getProperties().containsKey("blocked")) {
                camera.position.y = zombies.get(i).y * 64;
                camera.position.x = zombies.get(i).x * 64;
            } else {
                camera.position.y = player.getLinearY() * 64;
                camera.position.x = player.getLinearX() * 64;
            }
...
//                if (zombies.get(i) != zombies.get(j)) {
//                    if ((int) zombies.get(j).x == (int) zombies.get(i).x && (int) zombies.get(j).y == (int) zombies.get(i).y - 1) {
//                        check = false;
//                        zombies.get(i).setDown(false);
//                        break;
//                    } else if ((int) zombies.get(j).x == (int) zombies.get(i).x && (int) zombies.get(j).y == (int) zombies.get(i).y + 1) {
//                        check = false;
//                        zombies.get(i).setUp(false);
//                        break;
//
//                    } else if ((int) zombies.get(j).x == (int) zombies.get(i).x + 1 && (int) zombies.get(j).y == (int) zombies.get(i).y) {
//                        check = false;
//                        zombies.get(i).setRight(false);
//                        break;
//
//                    } else if ((int) zombies.get(j).x == (int) zombies.get(i).x - 1 && (int) zombies.get(j).y == (int) zombies.get(i).y) {
//                        check = false;
//                        zombies.get(i).setLeft(false);
//                        break;
//
//                    } else {
//                        check = true;
...
//            }
        ...
        if (maps.indexOf(map) == 4 && !robot.getKill()) {
...
//                float zombieWidth = robotX + (GameSettings.SCALED_TILE_SIZE * 1f);
//                float robotY = (robot.y * GameSettings.SCALED_TILE_SIZE);
//                float robotHeight = robotY + (GameSettings.SCALED_TILE_SIZE * 1f);
//
//                float bookX = (b.getX() * GameSettings.SCALED_TILE_SIZE) - 10;
//                float bookWidth = bookX + 9;
//                float bookY = (b.getY() * GameSettings.SCALED_TILE_SIZE) + 10;
//                float bookHeight = bookY + 9;
//
//                if ((zombieWidth >= bookWidth) && (robotX <= bookWidth)) {
