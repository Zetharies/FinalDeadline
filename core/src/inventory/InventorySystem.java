...
public class InventorySystem extends Window{
	...
	public static Skin texture; 
	
	private Item currentItem;

	public InventorySystem(TiledMapTileLayer collisions) {
		
		super("inventory", Inventory.STATUSUI_SKIN);
...
//		texture = new Skin(Gdx.files.internal("images/actionBar.png"));
//		return texture;
//	}
